    ...
    .then((response) => {
      ...
      if (response.data && response.data.results) {
        ...
        axios.get(`${this.store.baseUrl}/api/doctor/${doctor.id}/average_votes`)
          .then((averageVotesResponse) => {
            // Verifica che la risposta contenga la media dei voti
            if (averageVotesResponse.data && averageVotesResponse.data.average_votes) {
              // Assegna la media dei voti al dottore corrispondente
              doctor.averageRating = averageVotesResponse.data.average_votes;
            }
          })
          .catch((error) => {
